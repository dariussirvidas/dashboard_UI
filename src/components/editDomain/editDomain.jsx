        ...
        <>
            ...
            <div className="popup-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <p>Service Name
                        <input defaultValue={props.domain.service_Name} name="Service_name" type="text"
                               placeholder="Service Name"></input>
                    </p>
                    <p>Service URL
                        <input defaultValue={props.domain.url} name="Url_" type="text"
                               placeholder="Url (www.domain.com)"></input>
                    </p>
                    <p>Service Type &nbsp;
                    ...
                    <p>Parameters
                        <input defaultValue={props.domain.parameters} name="Parameters" type="text" placeholder="Add your parameters"></input>
                    </p>
                    <p>Email to notify
                        <input defaultValue={props.domain.notification_Email} name="Email" type="email" placeholder="name@mail.com"></input>
                    </p>
                    <p>Check interval (S)
                        <input defaultValue={props.domain.interval_Ms} name="Check_interval" type="text" placeholder="Time(s)"></input>
                    </p>
                    <p>Active
                        <input defaultChecked={props.domain.active} type="checkbox" name="active" value="active"></input></p>
