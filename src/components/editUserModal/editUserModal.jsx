                ...
                <div className="forma">
                    <form className="login-form" onSubmit={handleSubmit} id="formForPost">
                        ...
                        <input type="text" placeholder="Username" defaultValue={props.user.username} name="userName"
                               pattern="^[a-zA-Z0-9]{6,64}$" title="Your username needs to be between 6 and 64 characters long and contain one uppercase letter." required/>
                        <input type="text" placeholder="First Name" defaultValue={props.user.firstName} name="firstName"
                               pattern="^[a-zA-Z]{1,64}$" title="Your name needs to be between 1 and 64 characters long and contain one uppercase letter." required/>
