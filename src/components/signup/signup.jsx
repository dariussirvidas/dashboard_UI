                ...
                <div className="login-page">
                    <div className="form">
                        ...
                        <form className="login-form" onSubmit={handleSubmit} id="formForSignUp">
                            ...
                            <input type="text" placeholder="Last Name" name="lastName" pattern="^[a-zA-Z]{1,64}$" title="Your name needs to be between 1 and 64 characters long and contain one uppercase letter." required/>
